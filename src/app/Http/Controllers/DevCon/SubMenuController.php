...
class SubMenuController extends Controller
{
    ...
    {
        return $menu->render('dashboard::devSubMenu.index');
    }
    ...
    {
        $main_menus = Menu::all();
        return view('dashboard::devSubMenu.create', compact('main_menus'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('dashboard::devSubMenu.edit', compact('main_menus', 'sub_menu'));
    }
