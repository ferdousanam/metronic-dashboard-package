    ...
    <form id="menu-form" action="{{ route('main-menu.update', $main_menu->id) }}" method="POST" class="kt-form kt-form--label-right">
      <div class="kt-portlet__body">
        ...
        <div class="form-group row">
          ...
          <div class="col-10">
            <input class="form-control" type="text" id="route_name" name="route_name" value="{{ old('route_name', $main_menu->route_name) }}" placeholder="Route Name" required>
          </div>
        </div>
        <div class="form-group row">
          <label for="route_url" class="col-2 col-form-label">Route Url *</label>
          <div class="col-10">
            <input class="form-control" type="text" id="route_url" name="route_url" value="{{ old('route_url', $main_menu->route_url) }}" placeholder="Route Url" required>
          </div>
        </div>
        <div class="form-group row">
