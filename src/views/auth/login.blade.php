...
<head>
  ...
  <link href="{{asset('vendor/dashboard/assets/plugins/global/plugins.bundle.css')}}" rel="stylesheet" type="text/css"/>
  <link href="{{asset('vendor/dashboard/assets/css/style.bundle.css')}}" rel="stylesheet" type="text/css"/>
...
<script src="{{asset('vendor/dashboard/assets/plugins/global/plugins.bundle.js')}}" type="text/javascript"></script>
<script src="{{asset('vendor/dashboard/assets/js/scripts.bundle.js')}}" type="text/javascript"></script>
...
<script src="{{asset('vendor/dashboard/assets/js/pages/custom/login/login-general.js')}}" type="text/javascript"></script>
